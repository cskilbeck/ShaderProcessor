...
namespace Shaders
{
	...
	namespace UI
	{
		...
		{
			0x43425844,0xeabddc4c,0x9a092f24,0x14dadd8b,0x0573d22b,0x00000001,0x00000364,0x00000005,
		...
		struct VS : VertexShader, Aligned16
		{
			...
			VS()
				: VertexShader(VS_Data, 868, 1, VS_ConstBufferNames, 0, null, 0, null, null, null, VS_InputElements, _countof(VS_InputElements))
