...
namespace Shaders
{
	...
	{
		0x43425844,0x8fcc9308,0x4a5fab60,0x8888e02e,0x870bc61e,0x00000001,0x00000364,0x00000005,
		0x00000034,0x00000108,0x00000168,0x000001c0,0x000002e8,0x46454452,0x000000cc,0x00000001,
		...
		0x52444853,0x00000120,0x00010040,0x00000048,0x04000059,0x00208e46,0x00000000,0x00000004,
		...
		0x00000001,0x0100003e,0x54415453,0x00000074,0x00000008,0x00000001,0x00000000,0x00000004,
		0x00000004,0x00000000,0x00000000,0x00000001,0x00000000,0x00000000,0x00000000,0x00000000,
	...
	{
		0x43425844,0xbe40262b,0xd85072f9,0x703be887,0xa0318ee3,0x00000001,0x000002f8,0x00000005,
	...
	struct UI : ShaderState
	{
		...
		struct VS : VertexShader, Aligned16
		{
			...
			VS()
				: VertexShader(UI_VS_Data, 868, 1, UI_VS_ConstBufferNames, 0, null, 0, null, null, null, UI_VS_InputElements, _countof(UI_VS_InputElements))
		...
		struct PS : PixelShader, Aligned16
		{
			...
			PS()
				: PixelShader(UI_PS_Data, 760, 1, UI_PS_ConstBufferNames, 1, UI_PS_SamplerNames, 1, UI_PS_TextureNames, textures, samplers)
				, smplr(null)
				, page(null)
