...
namespace Shaders
{
	...
	{
		0x43425844,0x178d7d08,0x35864262,0xde739dc1,0x47969203,0x00000001,0x00000350,0x00000005,
		0x00000034,0x00000108,0x00000164,0x000001b8,0x000002d4,0x46454452,0x000000cc,0x00000001,
	...
	{
		0x43425844,0xbbf2e6b7,0x1253f3b9,0x1c3ff79a,0x49983683,0x00000001,0x000001cc,0x00000005,
	...
	struct Colored : ShaderState
	{
		...
		struct VS : VertexShader, Aligned16
		{
			...
			VS()
				: VertexShader(Colored_VS_Data, 848, 1, Colored_VS_ConstBufferNames, 0, null, 0, null, null, null, Colored_VS_InputElements, _countof(Colored_VS_InputElements))
		...
		Colored()
		{
			...
			DX::Device->CreateDepthStencilState((D3D11_DEPTH_STENCIL_DESC const *)Colored_DepthStencilDesc, &depthStencilState);
			DX::Device->CreateRasterizerState((D3D11_RASTERIZER_DESC const *)Colored_RasterizerDesc, &rasterizerState);
			DX::Device->CreateBlendState((D3D11_BLEND_DESC const *)Colored_BlendDesc, &blendState);
		}
