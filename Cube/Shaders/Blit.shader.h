...
namespace Shaders
{
	...
	// Data for Blit_VS is in Data\Blit_VS.cso

	// Data for Blit_PS is in Data\Blit_PS.cso
	...
	struct Blit : ShaderState
	{
		...
		struct VS : VertexShader, Aligned16
		{
			...
			VS()
				: VertexShader(TEXT("Data\\Blit_VS.cso"), 1, Blit_VS_ConstBufferNames, 0, null, 0, null, null, null, Blit_VS_InputElements, _countof(Blit_VS_InputElements))
		...
		struct PS : PixelShader, Aligned16
		{
			...
			PS()
				: PixelShader(TEXT("Data\\Blit_PS.cso"), 0, null, 1, Blit_PS_SamplerNames, 1, Blit_PS_TextureNames, textures, samplers)
				, smplr(null)
				, page(null)
			{
			}
