...
namespace Shaders
{
	...
	// Data for Phong_VS is in Data\Phong_VS.cso

	// Data for Phong_PS is in Data\Phong_PS.cso
	...
	struct Phong : ShaderState
	{
		...
		struct VS : VertexShader, Aligned16
		{
			...
			VS()
				: VertexShader(TEXT("Data\\Phong_VS.cso"), 1, Phong_VS_ConstBufferNames, 0, null, 0, null, null, null, Phong_VS_InputElements, _countof(Phong_VS_InputElements))
				, VertConstants(2, Phong_VS_VertConstants_Offsets, null, this, 0)
			{
			}
		};
		...
		struct PS : PixelShader, Aligned16
		{
			...
			PS()
				: PixelShader(TEXT("Data\\Phong_PS.cso"), 2, Phong_PS_ConstBufferNames, 1, Phong_PS_SamplerNames, 1, Phong_PS_TextureNames, textures, samplers)
				, tex1Sampler(null)
				, picTexture(null)
				, Camera(1, Phong_PS_Camera_Offsets, null, this, 0)
				, Light(4, Phong_PS_Light_Offsets, null, this, 1)
			{
			}
		};
