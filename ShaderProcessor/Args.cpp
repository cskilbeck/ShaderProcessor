...
uint32 optionMap[][2] = { { DISABLE_OPTIMIZATION, D3DCOMPILE_SKIP_OPTIMIZATION }, { INCLUDE_DEBUG_INFO, D3DCOMPILE_DEBUG },
                          { ERROR_ON_WARNING, D3DCOMPILE_WARNINGS_ARE_ERRORS },   { PACK_MATRIX_ROW_MAJOR, D3DCOMPILE_PACK_MATRIX_ROW_MAJOR },
                          { PARTIAL_PRECISION, D3DCOMPILE_PARTIAL_PRECISION },    { NO_PRESHADER, D3DCOMPILE_NO_PRESHADER },
                          { AVOID_FLOW_CONTROL, D3DCOMPILE_AVOID_FLOW_CONTROL },  { PREFER_FLOW_CONTROL, D3DCOMPILE_PREFER_FLOW_CONTROL },
                          { ENABLE_STRICTNESS, D3DCOMPILE_ENABLE_STRICTNESS },    { IEEE_STRICTNESS, D3DCOMPILE_IEEE_STRICTNESS },
...
uint32 GetCompilerOptionFlags()
{
    ...
    if(options[OPTIMIZATION_LEVEL]) {
        ...
        case 0:
            flag |= D3DCOMPILE_OPTIMIZATION_LEVEL0;
            break;
        case 1:
