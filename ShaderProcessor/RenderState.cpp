...
MAP comparison_map = { { "less", D3D11_COMPARISON_LESS },
...
std::map<param_type, std::function<void(string const &value, parameter const &param, uintptr offset)>> paramHandlerMap = {
    ...
    // bool
    { bool_param,
      [](string const &value, parameter const &param, uintptr offset) {
          BOOL r = TRUE;
...
std::map<string, param_vec> params = {
    ...
    { "culling",
      { "Culling mode & winding order (specifies the order of front-facing triangles)",
        0,
        0,
        { { "mode", enum_param, &rasterizerDesc.CullMode, culling_mode_map }, { "order", enum_param, &rasterizerDesc.FrontCounterClockwise, culling_order_map } } } },

    //////////////////////////////////////////////////////////////////////

    { "fill", { "Triangle fill mode", 0, 0, { { "mode", enum_param, &rasterizerDesc.FillMode, fill_mode_map } } } },
    ...
    { "depth_clip",
      { "Depth Clipping enable/disable",
        0,
        0,
        { { "enabled", bool_param, &rasterizerDesc.DepthClipEnable, {} }, { "disabled", inverse_bool_param, &rasterizerDesc.DepthClipEnable, {} } } } },

    //////////////////////////////////////////////////////////////////////

    { "scissor",
      { "Scissor enable/disable", 0, 0, { { "enabled", bool_param, &rasterizerDesc.ScissorEnable, {} }, { "disabled", inverse_bool_param, &rasterizerDesc.ScissorEnable, {} } } } },
    ...
    { "multisample",
      { "Multisample enable/disable",
        0,
        0,
        { { "enabled", bool_param, &rasterizerDesc.MultisampleEnable, {} }, { "disabled", inverse_bool_param, &rasterizerDesc.MultisampleEnable, {} } } } },
    ...
    { "anti_aliased_line",
      { "Anti-aliased line drawing enable/disable",
        0,
        0,
        { { "enabled", bool_param, &rasterizerDesc.AntialiasedLineEnable, {} }, { "disabled", inverse_bool_param, &rasterizerDesc.AntialiasedLineEnable, {} } } } },
...
char const *bool_vals[] = { "false", "true" };
        ...
        <div class="lightBackground nomargin vPadding">
            <div class="leftMargin rightMargin">
                ...
                <table>
                 ...
                 token.second.description, token.first.c_str(), index.c_str());
